...
<div id="accordion" role="tablist" aria-multiselectable="true">
  <div class="card">
    ...
    <div id="collapse01" class="collapse in" role="tabpanel" aria-labelledby="heading01">
      <div class="card-block">
        No. We sell only to approved retailers with a valid resale certificate and tax id #.
      </div>
    </div>
  </div>
  <div class="card">
...
-->
  <div class="card">
    ...
    <div id="collapseFour" class="collapse" role="tabpanel" aria-labelledby="headingFour">
      <div class="card-block">
       Yes, we have many displays designed specifically for our products. See our complete catalog for more details.
      </div>
    </div>
  </div>
  <div class="card">
...
<!--
  <div class="card">
    ...
    <div id="collapse09" class="collapse" role="tabpanel" aria-labelledby="heading09">
      <div class="card-block">
       Of course. Some of our best sellers started with suggestions from our customers.
      </div>
    </div>
  </div>
-->
